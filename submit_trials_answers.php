...
if( isset($_POST['data']) && isset($_SESSION['idUser']) && isset($_SESSION['group']) )
{
	...
	for( $numBlock=0; $numBlock<$nbBlocks; $numBlock++ )
	{
		...
		for ( $numStim = 0; $numStim < $nbStims; $numStim++ ) 
		{
		    ...
		    $strSql .= 'INSERT INTO resultsraw(idUser, numBlock, numTrial, item, isLeft, accuracy, rt, exclude) VALUES(';
